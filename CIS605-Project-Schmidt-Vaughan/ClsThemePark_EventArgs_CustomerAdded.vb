...
'File:                  ClsThemePark_EventArgs_CustomerAdded.vb
'Author:                Vaughan Schmidt
'Description:           Event Args for Custom Customer Events
...
Public Class ThemePark_EventArgs_CustomerAdded
...
#Region "Constructors"
    ...
    ''' </summary>
    ''' <param name="pCustomer">Customer that was added</param>
    Public Sub New(
...
#Region "Behavioral Methods"
    ...
    Private Function _toString() As String
        ...
        tmpStr = "( THEMEPARK EVENT_ARGS CUSTOMER ADDED: " _
            & "TheCustomer=" & _customer.ToString _
            & " )"
...
End Class 'ThemePark_EventArgs_CustomerAdded
